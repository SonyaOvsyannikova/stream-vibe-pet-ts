...
export const moviesMap = {
    ...
    'planned-to-watch-films': { slug:'planned-to-watch-films', name: 'Топ ожидаемых фильмов' },
}
...
const useMovie = (enabled = true) => {
    ...
    return {
        ...
        isLoading: topMoviesQuery.isLoading || bestMoviesQuery.isLoading || plannedMoviesQuery.isLoading,
        isError: topMoviesQuery.isError || bestMoviesQuery.isError || plannedMoviesQuery.isError,
    }
