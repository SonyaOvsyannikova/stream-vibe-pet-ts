...
import {
  MovieCollectionByGrouped,
  useMoviesGrouped,
} from '@/shared/hooks/useMoviesGrouped.ts'
...
const AllGenresCategories = () => {
  ...
  const { groupedMoviesPageOne, groupedMoviesPageTwo, isLoadingPageOne } =
        ...
        isLoadingPageOne ? (
          ...
          <>
            <Categories
              ...
              renderItem={(collection: MovieCollectionByGrouped) => (
                <CategoriesCard
                  key={collection.id}
                  variant={'Our Genres'}
